...
define('TSTAMP', 'Zuletzt gesucht am');
...
define('CREATE_LP', 'Landingpage erstellen');
define('PRODUCT_ASSIGNEMNT', 'Produkt(en) zuweisen');
define('QUERY_TITLE_TEXT', 'Suchergebnisse f&uuml;r %s anzeigen');
define('SEARCH_FILED_PLACEHOLDER', 'Suchbegriff hier eingeben');
define('SEARCH_BUTTON_LABEL', 'suchen');
define('TOGGLE_CHECKBOX_LABEL', 'Alle');
define('SEARCH_NO_RESULTS', 'F&uuml;r den Suchbegriff <strong>%s</strong> wurden keine Produkte gefunden :(');
define('VIEW_IN_SHOP', '%s im Shop ansehen');
